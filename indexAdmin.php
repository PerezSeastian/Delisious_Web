			...
			<div class="fh5co-main-nav">
				<div class="container-fluid">
					<div class="fh5co-menu-1">
						...
						<a href="#" data-nav-section="about"><i class="fas fa-info-circle"></i> Tabla de usuarios</a>
						<a href="#" data-nav-section="features"><i class="fas fa-concierge-bell"></i> Tabla de
							Reservaciones </a>
					</div>
